...
def calculate_annual_expenses(monthly_payment, state_income_tax_rate, monthly_common_expenses, salary):
    ...
    total_annual_expenses = annual_house_payment + total_state_income_tax + annual_common_expenses
    return total_annual_expenses, annual_house_payment, total_state_income_tax, annual_common_expenses
...
def display_results(current_annual_expenses, new_annual_expenses, net_new_expenses):
    results_data = {
        'Description': ['Current Annual Expenses', 'New Annual Expenses', 'Net New Expenses'],
        'Amount ($)': [f'{current_annual_expenses:,.2f}', f'{new_annual_expenses:,.2f}', f'{net_new_expenses:,.2f}']
    }
...
def display_breakdown(current_annual_house_payment, new_annual_house_payment, current_total_state_income_tax, new_total_state_income_tax, current_annual_common_expenses, new_common_expenses, current_annual_property_tax, new_annual_property_tax):
    st.subheader('Breakdown of Additional Expenses')
    breakdown_data = {
        'Description': ['House Payment', 'State Income Tax', 'Common Expenses', 'Property Tax'],
        'Current Amount ($)': [f'{current_annual_house_payment:,.2f}', f'{current_total_state_income_tax:,.2f}', f'{current_annual_common_expenses:,.2f}', f'{current_annual_property_tax:,.2f}'],
        'New Amount ($)': [f'{new_annual_house_payment:,.2f}', f'{new_total_state_income_tax:,.2f}', f'{new_common_expenses:,.2f}', f'{new_annual_property_tax:,.2f}'],
        'Net Difference ($)': [f'{new_annual_house_payment - current_annual_house_payment:,.2f}', f'{new_total_state_income_tax - current_total_state_income_tax:,.2f}', f'{new_common_expenses - current_annual_common_expenses:,.2f}', f'{new_annual_property_tax - current_annual_property_tax:,.2f}']
    }
...
def display_detailed_calculations(current_monthly_house_payment, current_annual_house_payment, current_annual_property_tax, current_total_state_income_tax, current_annual_expenses, current_annual_common_expenses,
                                  new_monthly_house_payment, new_annual_house_payment, new_annual_property_tax, new_total_state_income_tax, new_common_expenses, new_annual_expenses, current_state_income_tax_rate, spending_increase_percentage, new_state_income_tax_rate, current_monthly_common_expenses, current_salary, new_salary, net_new_expenses):
    ...
    detailed_calculations = {
        'Calculation Steps': [
            ...
            f'<h4><i class="fas fa-calculator fa-icon"></i>Current Total Annual Expenses:</h4> <p>${current_annual_house_payment:,.2f} (House Payment) + ${current_total_state_income_tax:,.2f} (State Income Tax) + ${current_annual_common_expenses:,.2f} (Common Expenses) = ${current_annual_expenses:,.2f}</p>',
            ...
            f'<h4><i class="fas fa-exchange-alt fa-icon"></i>Net New Expenses:</h4> <p>${new_annual_expenses} (New Total Annual Expenses) - ${current_annual_expenses} (Current Total Annual Expenses) = ${net_new_expenses:,.2f}</p>'
        ]
    }
...
def main():
    ...
    if st.button('Calculate Required Salary'):
        try:
            ...
            current_annual_expenses, current_annual_house_payment, current_total_state_income_tax, current_annual_common_expenses = calculate_annual_expenses(current_monthly_house_payment, current_state_income_tax_rate, current_monthly_common_expenses, current_salary)

            # Calculate new annual expenses without increase
            new_annual_expenses, new_annual_house_payment, new_total_state_income_tax, _ = calculate_annual_expenses(new_monthly_house_payment, new_state_income_tax_rate, current_monthly_common_expenses, new_salary)
            
            # Calculate new common expenses with increase
            new_common_expenses = current_monthly_common_expenses * 12 * (1 + spending_increase_percentage / 100)
            new_annual_expenses += new_common_expenses - (current_monthly_common_expenses * 12)
            ...
            breakdown_df = display_breakdown(current_annual_house_payment, new_annual_house_payment, current_total_state_income_tax, new_total_state_income_tax, current_annual_common_expenses, new_common_expenses, current_annual_property_tax, new_annual_property_tax)
            ...
            detailed_calculations = display_detailed_calculations(current_monthly_house_payment, current_annual_house_payment, current_annual_property_tax, current_total_state_income_tax, current_annual_expenses, current_annual_common_expenses,
                                                                  new_monthly_house_payment, new_annual_house_payment, new_annual_property_tax, new_total_state_income_tax, new_common_expenses, new_annual_expenses,
                                                                  current_state_income_tax_rate, spending_increase_percentage, new_state_income_tax_rate, current_monthly_common_expenses, current_salary, new_salary, net_new_expenses)
