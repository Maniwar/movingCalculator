...
def display_breakdown(current_annual_common_expenses, new_annual_house_payment, new_total_state_income_tax, new_common_expenses, current_annual_property_tax, new_annual_property_tax, net_new_expenses):
    ...
    breakdown_data = {
        ...
        'Current Amount ($)': [f'{current_annual_common_expenses:,.2f}', '', '', '', f'{current_annual_property_tax:,.2f}', '', ''],
        ...
        'Net Difference ($)': ['', '', '', '', '', '', f'{net_new_expenses:,.2f}']
    }
...
def display_detailed_calculations(current_monthly_house_payment, current_annual_house_payment, current_annual_property_tax, current_total_state_income_tax, current_annual_expenses, current_annual_common_expenses,
    ...
    detailed_calculations = {
        'Calculation Steps': [
            ...
            f'<h4><i class="fas fa-calculator fa-icon"></i>Net Difference:</h4> <p>${net_new_expenses:,.2f}</p>'
        ]
    }
